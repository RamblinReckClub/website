    ...
    <div class="container">
        <div class='blog-header'>
            ...
            <div class='row text-center'>
                ...
                <div class='row text-center'>
                    <!--        <div class='col-sm-4 col-xs-12 mb-3 mb-sm-6' style="text-align: center;">-->
                    <i>The Ramblin Reck Club’s sign-up form is for individual registrations. Organizations wishing to
                        receive
                        points must also sign up for this event using SCPC’s Homecoming waiver, found at <a
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div margin="col-4">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/7ZbW9P1A7xY" frameborder="0"
            ...
            <div class="row">
                <div class="col-12">
                    <p class="text-muted"><i>Have any questions? Reach out to us at <a
                                href="mailto:rrccakerace@gmail.com">rrccakerace@gmail.com</a> or <a
