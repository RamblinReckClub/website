    ...
    <div class="row mb-2">
        ...
        <div class="col-md-6">
            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                ...
                <img class="card-img-right img-fluid flex-auto d-none d-md-block" data-src="/img/2026/sof-reck-sm-hc.png" style="width: 200px; height: 250px;" src="/img/2026/sof-reck-sm-hc.png" data-holder-rendered="true">
            </div>
        </div>
    </div>
    <div class="row mb-2">
