...
<a href="/friends.php?memberId=<?php echo (int)$_POST['memberID']; ?>">Friends List</a><br/><br/>
<a href="/memberProfile.php?memberId=<?php echo (int)$_POST['memberID']; ?>">View Profile</a>
</div><br/>
        ...
        <?php
            if (($isAdmin || $isSecretary || $isTreasurer || $isVP) || $currentMemID == $memberID) {
                if ($currentMemberStatus == 'member' || $currentMemberStatus == 'probate') {
                    ...
                    echo '</td>';
                    echo '<td colspan="3">';
                    echo  (($events - $mandatory) >= 20) ? "Yes" : "<b>No</b>";
                    echo  "</td></tr>";
