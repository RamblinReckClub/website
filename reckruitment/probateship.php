...
<div class="container">
    ...
    <img class="img-responsive mb-2" src="/img/2023/probate_2022.jpeg" width="100%" alt="Picture of members of Probate Class 20">
    ...
    <div class="row mb-2">
        <div class="col-md-6">
            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                ...
                <img class="card-img-right img-fluid flex-auto d-none d-md-block" src="/img/2023/Bookmobile_2.JPEG" alt="Keshav (former RRC member) with Bookmobile." style="width: 200px; height: 250px;">
            </div>
        </div>
        <div class="col-md-6">
            <div class="card flex-md-row mb-4 box-shadow h-md-250">
