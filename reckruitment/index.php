...
<h2 class="mb-3">Reckruitment Process</h2>
    ...
    <ul>
        <li>Attendance at the <a href="#first-social">first social</a> on <strong>Monday, January 26th, 2026</strong></li>
        <li><a href="#interviews">Interviews</a> (Individual and Group), occurring <strong> January 27th - January 29th, 2026</strong></li>
        <li>Attendance at the <a href="#second-social">second social</a> on <strong>Saturday, January 31st, 2026</strong></li>
        <li>Attendance at the all-club Spring Retreat (Date TBD if selected to be a 2026 probate)</li>
    </ul>
    ...
    <p>Any absences or potential conflicts with the required events should be brought to the attention of <a href="mailto:membershipchair@reckclub.org">Kyle Ralyea and Ria Nayar</a>, Ramblin’ Reck Club Recruitment Chairs, no later than January 23rd, 2026.</p>
...
<h4 class="mb-2" id="written-application">Written Application</h4>
    ...
    <div class='row text-center'>
        <div class='col-sm col-xs-12 mb-5 mb-sm-0'>
            <a class='btn btn-md btn-primary' href="https://forms.gle/1EHyGZGoP6FqvQBr8" target="blank"><strong>APPLY HERE!</strong></a>
        </div>
    </div>
...
<h4 class="mb-2" id="interviews">Interviews (Invite Only)</h4>
    ...
    <p>The interview portion of Reckruitment is designed to allow for Reck Clubbers to get to know applicants on a more personal basis. We want to give each applicant the time to express their ideas, commitment, and personality. The interview portion consists of an individual interview and a group interview. Interviewees will sign up for an interview time slot during check-in at the first social. Dress code for this event is semi-formal attire.</p>
     <ul>
        ...
        <li><strong>Thursday, January 29th from 7:30pm-11:30pm</strong></li>
    </ul>
