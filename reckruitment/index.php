...
<h2 class="mb-3">RECKruitment Process</h2>
    ...
    <p>Every spring semester, Ramblin’ Reck Club holds RECKruitment in order to take in a new class of probates (probationary members). These probates are selected from a pool of applicants who must first submit an application and attend a series of RECKruitment events.  Email <a href="mailto:membershipchair@reckclub.org">Simran Patel and Gal Ovadia</a>, Ramblin' Reck Club Recruitment Chairs, if you have questions or concerns. Find the breakdown of these events below:</p>

    <h4 class="mb-3">Overview of the 2025 Application Process and Timeline</h4>

    <p class="mb-0">A full and complete application for membership includes:</p>
    <ul>
        <li>A <a href="#written-application">written application</a> submitted by <strong>Sunday, Februrary 2nd, 2025</strong></li>
    ...
    <ul>
        <li>Attendance at the <a href="#first-social">first social</a> on <strong>Monday, February 10th, 2025</strong></li>
        <li><a href="#interviews">Interviews</a> (Individual and Group), occurring <strong> February 11th - February 13th, 2025</strong></li>
        <li>Attendance at the <a href="#second-social">second social</a> on <strong>Saturday, February 15th</strong></li>
        <li>Attendance at the all-club Spring Retreat (Date TBD if selected to be a 2025 probate)</li>
    </ul>
    ...
    <p>Any absences or potential conflicts with the required events should be brought to the attention of <a href="mailto:membershipchair@reckclub.org">Simran Patel and Gal Ovadia</a>, Ramblin’ Reck Club Recruitment Chairs, no later than February 2nd, 2025.</p>
...
<h4 class="mb-2" id="written-application">Written Application</h4>
    ...
    <div class='row text-center'>
        <div class='col-sm col-xs-12 mb-5 mb-sm-0'>
            <a class='btn btn-md btn-primary' href="https://forms.gle/cdiEqBsiy84Dhbme6" target="blank"><strong>APPLY HERE!</strong></a>
        </div>
    </div>
...
<h4 class="mb-2" id="second-social">Second Social (Invite Only)</h4>
    <p>After all interviews have been conducted, applicants will be notified whether they will advance to the next round of RECKruitment. During this second round, applicants will attend a mandatory second social held from <strong>12:00PM - 3:00PM on Saturday, February 15th</strong>. Further details for this event will be sent out to those invited applicants only.</p>

<hr class="mb-3"> <!--    adds dividing line-->
    <p>Any time conflicts with these events should be brought to the attention of <a href="mailto:membershipchair@reckclub.org">Simran Patel and Gal Ovadia</a>, Ramblin’ Reck Club Recruitment Chairs, no later than <strong>February 2nd</strong>.</p>
